                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <input type="password" class="form-control" name="txtPassword" id="password" placeholder="Enter your Password"  value="${param.txtPassword}"/>
                                        </div>
                                    </div>
                                    <p class="text-center">   
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="cols-sm-10">
                                        <div class="input-group">
                                            <input type="password" class="form-control" name="txtConfirm" id="confirm" placeholder="Confirm your Password"  value="${param.txtConfirm}"/>
                                        </div>
                                    </div>
                                    <p class="text-center">   
                                        <font color="red">${error.getConfirmPasswordError()}</font>
                                    </p>
                                </div>
                                <div class="form-group ">
